...
class OtpVerificationSignUp extends StatefulWidget {
  const OtpVerificationSignUp({Key? key}) : super(key: key);
...
class _OtpVerificationSignUpState extends State<OtpVerificationSignUp> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      appBar:CustomeAppbar(title: AppStrings.verification.toUpperCase()
          ),
       ...
       SizedBox(height: sizeHeight(context) * 0.06),
                  ...
                  PinCodeTextField(
                    ...
                    onCompleted: (v) {
                      if (v.length == 6) {
                        AppNavigation.navigateToRemovingAll(context, Routes.deshboardPageRoute);
                      } else {
