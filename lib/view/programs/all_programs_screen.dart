...
class AllProgramsView extends StatefulWidget {
  const AllProgramsView({Key? key}) : super(key: key);

  @override
  State<AllProgramsView> createState() => _AllProgramsViewState();
}

class _AllProgramsViewState extends State<AllProgramsView> {


  @override
  Widget build(BuildContext context) {
    return Column(
      children: List.generate(6, (index) => programBox()),
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            child: CustomeButton(
              ...
              text: AppStrings.buynow.toUpperCase(),
              onTap: () {
